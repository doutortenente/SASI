...
const config: Config = {
  ...
  theme: { extend: {
    colors: {
      ...
      grav: { stable:"var(--grav-stable-solid)", watcher:"var(--grav-watcher-solid)",
              unstable:"var(--grav-unstable-solid)", critical:"var(--grav-critical-solid)", deceased:"var(--grav-deceased-solid)" },
      sofa: { low:"var(--sofa-low)", medium:"var(--sofa-medium)", high:"var(--sofa-high)", critical:"var(--sofa-critical)" },
    },
