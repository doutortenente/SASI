...
$$;
alter table public.eventos_clinicos
  validate constraint eventos_tipo_fk;
-- destrutivo (substituido pela FK acima):
alter table public.eventos_clinicos
  drop constraint if exists eventos_clinicos_tipo_check;
