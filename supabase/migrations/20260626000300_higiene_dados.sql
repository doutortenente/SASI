...
update public.eventos_clinicos
...
alter table public.pacientes
  alter column patient_summary set default '{}'::jsonb;
update public.pacientes
set patient_summary = '{}'::jsonb
where patient_summary is null;

-- 5) atb-dday: meta de duracao do curso (decisao clinica; D-day ja e derivado em vw_dias_atb_ativo).
alter table public.atbs
  add column if not exists duracao_planejada_dias int;
