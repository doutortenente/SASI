...
begin
  ...
  values (new.paciente_id, new.id, new.user_id, b_rotulo, b_sev,
...
insert into public.alert_rules (tipo_evento, comparador, limiar, severidade, rotulo, mensagem, fonte, ordem)
values ('pam_min', 'lt', 60, 'critical', 'hipotensao_critica_pam', 'PAM {v} < 60 mmHg',
        'ACC Cardiogenic Shock 2025 doi:10.1016/j.jacc.2025.02.018', 1),
       ('pam_min', 'lt', 65, 'warning', 'hipotensao_pam', 'PAM {v} < 65 mmHg',
        'ACC Cardiogenic Shock 2025 doi:10.1016/j.jacc.2025.02.018', 2),
       ('pas_min', 'lt', 90, 'critical', 'hipotensao_critica_pas', 'PAS {v} < 90 mmHg',
        'ACC Cardiogenic Shock 2025 doi:10.1016/j.jacc.2025.02.018', 3),                          -- DORMENTE
       ('fc', 'gt', 100, 'warning', 'taquicardia', 'FC {v} > 100 bpm',
        'ACC Cardiogenic Shock 2025 doi:10.1016/j.jacc.2025.02.018', 4),
       ...
       ('spo2', 'lt', 85, 'critical', 'hipoxemia_critica', 'SpO2 {v} < 85%',
        'Critical Care 2021 doi:10.1186/s13054-021-03766-4', 8),
       ('spo2', 'lt', 90, 'warning', 'hipoxemia', 'SpO2 {v} < 90%',
        'JAMA Netw Open 2026 doi:10.1001/jamanetworkopen.2026.3290', 9),
       ('lactato', 'gt', 2.0, 'warning', 'hipoperfusao_lactato', 'Lactato {v} > 2.0 mmol/L',
        'ACC Cardiogenic Shock 2025 doi:10.1016/j.jacc.2025.02.018', 10),
       ('lactato', 'gte', 4.0, 'critical', 'lactato_muito_alto', 'Lactato {v} >= 4.0 mmol/L',
        'Surviving Sepsis ICM 2017 doi:10.1007/s00134-017-4683-6', 11),
       ('gcs', 'lt', 9, 'critical', 'rebaixamento_grave_gcs', 'GCS {v} < 9',
        'ERC/ESICM Post-Resus 2025 doi:10.1016/j.resuscitation.2025.110809', 13),
       ('gcs', 'lt', 12, 'warning', 'alteracao_consciencia_gcs', 'GCS {v} < 12', 'JBDS HHS 2022 doi:10.1111/dme.15005',
        14),
       ('ht', 'gte', 44, 'warning', 'hemoconcentracao_ht', 'HT {v} >= 44%',
        'ACG Acute Pancreatitis 2024 doi:10.14309/ajg.0000000000002645', 15),
       ('ht', 'lt', 24, 'warning', 'anemia_importante_por_ht', 'HT {v} < 24%',
        'ACG Acute Pancreatitis 2024 doi:10.14309/ajg.0000000000002645', 16),
       ('ht', 'lt', 21, 'critical', 'anemia_critica_por_ht', 'HT {v} < 21%',
        'ACG Acute Pancreatitis 2024 doi:10.14309/ajg.0000000000002645', 17),
       ('ur', 'gte', 70, 'warning', 'uremia_importante', 'UR {v} >= 70 mg/dL',
        'ACG Acute Pancreatitis 2024 doi:10.14309/ajg.0000000000002645', 18),
       ('ur', 'gte', 100, 'critical', 'uremia_grave', 'UR {v} >= 100 mg/dL',
        'RRT timing meta Critical Care 2021 doi:10.1186/s13054-020-03451-y', 19)
...
insert into public.alert_rules (tipo_evento, comparador, limiar, severidade, rotulo, mensagem, fonte, ordem)
values ('glicemia', 'gt', 250, 'warning', 'hiperglicemia', 'Glicemia {v} > 250 mg/dL', null, 60),
