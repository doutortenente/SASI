...
$$
  ...
  begin
    ...
    -- ===================================================================
    insert into public.pacientes (leito, uti, nome, idade, peso, altura, hd, data_adm, alergias,
                                  gravidade, status_leito, isolation, dispositivos, riscos_flags, patient_summary)
    values ('<<LEITO ex: L05>>', -- OBRIGATÓRIO  (padrão do leito: L01..L12)
            ...
            jsonb_build_object(
              ...
              'interconsultas',
              '[]'::jsonb, -- planilha "Especialidades": [{"especialidade":"Nefrologia","data":"2026-07-24","status":"pendente","notas":"..."}]
              'programacao',
              '[]'::jsonb, -- [{"descricao":"TC de crânio","data":"2026-07-25","tipo":"exame","status":"pendente"}]
              'resumo_sistemas',
              '[]'::jsonb, -- [{"id":"hemo_cv","label":"Hemo/CV","emoji":"🫀","texto":"..."}]  ids: hemo_cv,infecto,renal,gi,resp,snc,pontos_criticos
    ...
    -- ===================================================================
    insert into public.evolucoes (paciente_id, data_evolucao, plantao,
