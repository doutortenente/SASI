...
-- idx_pacientes_nome_trgm (busca fuzzy)
...
ALTER TABLE public.alerts_log
  ADD CONSTRAINT alerts_log_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users (id) ON DELETE SET NULL; -- [FK->auth.users]
ALTER TABLE public.alerts_log
