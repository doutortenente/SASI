---
tags: [sasi, template-base, doutrina, canonico]
versao: SASI-TEMPLATE-BASE v2.0
status: FONTE DA VERDADE ÚNICA
---

# 🪖 SASI — TEMPLATE-BASE CLÍNICO CANÔNICO — v2.0 (Ramo C)

> **STATUS: FONTE DA VERDADE ÚNICA.**
> Este bloco é **IDÊNTICO** nas duas skills (`admissao-uti` e `sasi-ingest-export`).
> Alterou aqui → replica na outra no mesmo commit. **Divergência entre as duas cópias = bug clínico-legal.**
> Versionar sempre: `SASI-TEMPLATE-BASE vX.Y`. Toda nota gerada carrega a versão no rodapé.
