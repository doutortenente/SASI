...
| `supabase/` | **O banco** — schema (baseline 26-jun-2026), migrations, edge functions, queries de plantão |
...
npm run build | typecheck | lint  # verificações (Node 24)
```
